...
(doom! :input
       ...
       (vertico +icons)    ; the search engine of the future ; (default)
       ...
       (csharp +dotnet +tree-sitter +lsp) ; unity, .NET, and mono shenanigans
       ...
       (org +brain +dragndrop +hugo +present +roam2)  ; organize your plain life in plain text
       ...
       (rust +treesitter +lsp)       ; Fe2O3.unwrap().unwrap().unwrap().unwrap()
       ;;scala             ; java, but good
