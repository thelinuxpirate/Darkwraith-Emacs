...
;; accept. For example:
;;
(setq doom-font (font-spec :family "Comic Mono" :size 16 :weight 'semi-light)
      doom-variable-pitch-font (font-spec :family "Comic Mono" :size 16))
...
(setq fancy-splash-image "~/.config/doom/.assests/frampt.png")
